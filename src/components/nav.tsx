...
export const Nav = ()=> {
    return(
        <nav className="fixed px-20 left-0 right-0 top-0 h-16 bg-white flex justify-between items-center">
            <div>
            ...
            <ul className="flex items-center gap-16 text-xl font-semibold">
                ...
                <a href="" className="hover:text-primary transition-colors duration-300">Tecnologias</a>
                <a href="" className="hover:text-primary transition-colors duration-300">Projetos</a>
