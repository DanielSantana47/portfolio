        ...
        <div className="w-full flex justify-center gap-16">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex gap-16">
                        ...
                        <a href={site} className="w-52 text-center py-3 text-2xl bg-primary shadow-lg shadow-black/30 rounded-md text-white font-semibold hover:bg-red-600 hover:scale-110 hover:shadow-xl hover:shadow-black/20 transition-all duration-300">
                            Site
                        </a>
                    </div>
                </div>
