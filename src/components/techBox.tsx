...
export const TechBox = ({icon, label}: TechBoxType)=> {
    return(
        <div className="flex items-center justify-center">
            <div className={`bg-black/10 p-20 flex  flex-col items-center justify-center rounded-lg group shadow-lg shadow-primary/40 hover:shadow-xl hover:shadow-primary/40 hover:scale-105 transition-all duration-300`}>
